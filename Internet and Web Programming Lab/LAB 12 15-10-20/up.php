...
if(isset($_POST['submit'])){
  ...
  if($conn->connect_error){
    ...
    $qu="update employee set emp_name='$en', emp_age='$ea', emp_deg='$ed', emp_sal='$es' where emp_id='$ei';";
    $st=mysqli_query($conn,$qu);
    if($st)
      echo "<h1 align=center>Record of the Employee Updated!</h1>";
    else
      echo "<h1 align=center>Failed to Update Employee's Record!</h1>";
  }
}
?>
<!DOCTYPE html>
...
<div class="Reservation-page">
  <div class="form">
    <form class="Reservation-form" method="post">
      <h1 align="center" style="font-family: Calibri; margin-top: 0px;">Employee's Record Updation</h1>
